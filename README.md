...
- CI (Continuous Integration) setup with [GitHub Actions](https://github.com/features/actions) for automated testing, type-checking, and publishing the package to npmjs.
